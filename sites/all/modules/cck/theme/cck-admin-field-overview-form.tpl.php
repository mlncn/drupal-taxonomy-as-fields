<?php
// $Id: cck-admin-field-overview-form.tpl.php,v 1.5 2009/02/03 19:53:48 karens Exp $
?>
<div>
  <?php print $help; ?>
</div>
<table id="cck-field-overview" class="sticky-enabled">
  <thead>
    <tr>
        ...
        case 'add_new_field': ?>
          <td>
            ...
            <div class="<?php print $row->label_class; ?>">
              <div class="cck-new"><?php print theme('advanced_help_topic', 'cck', 'add-new-field') . t('New field'); ?></div>
              <?php print $row->label; ?>
            </div>
          </td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->weight . $row->parent . $row->hidden_name; ?></td>
          <td colspan="2"><div class="cck-new">&nbsp;</div><?php print $row->field_name; ?></td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->type; ?></td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->widget_type; ?></td>
          <?php break;
        case 'add_existing_field': ?>
          <td>
            <?php print $row->indentation; ?>
            <div class="<?php print $row->label_class; ?>">
              <div class="cck-new"><?php print theme('advanced_help_topic', 'cck', 'add-existing-field') . t('Existing field'); ?></div>
              <?php print $row->label; ?>
            </div>
          </td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->weight . $row->parent . $row->hidden_name; ?></td>
          <td colspan="3"><div class="cck-new">&nbsp;</div><?php print $row->field_name; ?></td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->widget_type; ?></td>
          <?php break;
       case 'add_new_group': ?>
          <td>
            <?php print $row->indentation; ?>
            <div class="<?php print $row->label_class; ?>">
              <div class="cck-new"><?php print theme('advanced_help_topic', 'cck', 'add-new-group') . t('New group'); ?></div>
              <?php print $row->label; ?>
            </div>
          </td>
          <td><div class="cck-new">&nbsp;</div><?php print $row->weight . $row->parent . $row->hidden_name; ?></td>
